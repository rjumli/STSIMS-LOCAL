<template>
    <div class="offcanvas offcanvas-end" :class="showOff ? 'show' : 'hiding'"  tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
        <div class="offcanvas-header bg-primary">
            <h5 class="offcanvas-title text-white" id="offcanvasExampleLabel">
                Ongoing Scholar Filter
            </h5>
