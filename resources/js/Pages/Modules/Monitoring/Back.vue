            ...
            <div class="table-responsive">
                <table class="table table-nowrap align-middle">
                    <thead class="table-light fs-11">
                        <tr>
                            <th class="fixed-column" style="width: 2%;">Name</th>
                            <th class="text-center" style="width: 25%;">Enrollment</th>
                            <th class="text-center" style="width: 15%;">Category</th>
                            <th class="text-center" style="width: 15%;">Program</th>
                            <th class="text-center" style="width: 15%;">Subprogram</th>
                            <th class="text-center fixed-column" style="width: 15%;">Status</th>
                            <th class="text-center fixed-column" style="width: 18%;"></th>
                        </tr>
                    </thead>
                    <tbody>
...
th, td.fixed-column:last-child {
    left: auto;
    right: 0;
}
th.fixed-column:last-child {
    right: 0;
}
