<template>
    ...
    <h6 class="fs-11 text-muted text-uppercase mb-3">Schools Semester for <span class="fw-semibold">{{settings.data.academic_year}}</span></h6>
...
<script>
import Missed from './Modals/Missed.vue';
import Grades from './Modals/Grades.vue';
import Benefits from './Modals/Benefits.vue';
import Unenrolled from './Modals/Unenrolled.vue';
import Termination from './Modals/Termination.vue';
export default {
    components: { Missed, Grades, Benefits, Unenrolled, Termination },
    props: ['settings','dropdowns','counts'],
    data(){
        return {
